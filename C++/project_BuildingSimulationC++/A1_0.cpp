...
int main(int argc, char **argv)
{
	if(argc == 8)
	{
		...
		Building new_building(N, Nf, Ng, No, Nl, 0);
		...
		for(int i = 0; i < L; i++)
		{	//Code below is kinda messy sorry (it was not on my main design to continue until all citizens done.
			//I just read it by pure luck (while doing exercise2) on the forum. I was following the instructions that didnt mention entering more than L
			//so i had to rewrite 30% of the code and part below was the cherry so i didnt have to rewrite all of it...:P)
			g_entered = 0;
