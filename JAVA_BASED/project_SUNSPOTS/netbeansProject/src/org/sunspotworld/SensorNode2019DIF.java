...
public class SensorNode2019DIF extends MIDlet
{
    ...
    public final double meanRandom = randomD.nextInt((20 - 1) + 1) + 1;//mean between 1 and 20
    public final double stdRandom = randomD.nextInt((10 - 1) + 1) + 1;//std between 1 and 10
    ...
    {
        try {
            System.out.println("SensorNode2019DIF MIDlet STARTING ...");
            RadiostreamConnection conn =
                    (RadiostreamConnection)Connector.open("radiostream://0A00.020F.0000.1003:100");
            DataOutputStream dos = conn.openDataOutputStream();
            try {
                System.out.println("USING RANDOM MEAN : " + meanRandom);
                System.out.println("USING RANDOM STD : " + stdRandom);
                ...
                while(startDataCreation == true)
                {
                    for(int i = 0; i < 8; ++i)
                    {
                        inputBoxM[i] = gngBoxMuller(meanRandom, stdRandom);
            ...
            System.out.println("SensorNode2019DIF MIDlet EXITING ...");
